 ...
 * @since 2025-11-01
 */
public class GisUtilbak implements AutoCloseable {
     ...
     */
    private GisUtilbak(Config config) {
    ...
    public static class Builder {
         ...
         * @see GisUtilbak
         */
        public GisUtilbak build() {
            return new GisUtilbak(config);
        }
    }
